...
namespace D15rekeningkantoor.CUI
{
    public class RekeningApp
    {
        public void Run()
        {
            ...
            Kantoor kantoor1 = new Kantoor(Mieke,adresMieke);
            ...
            Console.WriteLine($"{Jan.Voornaam} {Jan.FamilieNaam},{adresJan.AdresSamen()}");


            //test mieke adres
            Console.WriteLine(adresMieke.AdresSamen());
            ...
            {
                Console.WriteLine($"Mieke woont in {Mieke.AdresP}");
            }
        }
    }
}
