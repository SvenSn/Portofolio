...
Via Instellingen kun je EUR (euro), USD (US dollar), GBP (Britse pond), AUD (Australische dollar) of CAD (Canadese dollar) kiezen. De keuze wordt op alle geldbedragen toegepast. Alleen de weergave verandert; er worden geen wisselkoersen gebruikt.
